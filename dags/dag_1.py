...
def fetch_weather_data():
    try:
        # Realiza la solicitud a la API de clima (Coordenadas Santiago, Chile)
        api_url = 'https://api.openweathermap.org/data/2.5/weather?lat=-33.457&lon=-70.648&appid=a03874207feb68965f8ca246322fdfcf'
